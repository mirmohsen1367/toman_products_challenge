...
class CreateUpdateProductSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if "images" in validated_data:
            product_data_list = [ProductImage(image=prduct_image, product=product) for  
                                 prduct_image in  validated_data["images"]]
    ...
    def update(self, instance, validated_data):
        ...
        if "images" in validated_data:
            ...
            product_data_list = [ProductImage(image=prduct_image, product=instance) for  
                                 prduct_image in  validated_data["images"]]
            ProductImage.objects.bulk_create(product_data_list)            
        instance.save()
        return instance
